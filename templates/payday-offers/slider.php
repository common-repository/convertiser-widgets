...
<section class="cr--payday-slider">
    ...
    foreach ($offers as $offer) :
        ...
        $featured           = $i <= $atts['highlight']
            ? 'cr--payday-slider__item--featured' . ' ' . $featuredItemStyle
            : '';
        ...
        <section class="cr--payday-slider__item-slide-separator">
            <section
                class="cr--payday-slider__item <?php echo esc_attr($featured !== '' ? $featured : $itemStyle); ?>"
                id="payday_offer_<?php echo esc_attr($id);?>">

                <?php if (strlen($offer['promotion']) > 0 && $atts['show_loan_promotion']) : ?>
                    <div
                        class="cr--payday-slider__item__promo <?php echo esc_attr($promoTextStyle);?>">
                ...
                <div class="cr--payday-slider__item__wrapper">
                    ...
                    <div class="cr--payday-slider__item__logo">
                        <div class="cr--payday-slider__item__padder">
                            <a <?php echo $onClick; ?>
                                class="cr--payday-slider__item__logo__link"
                    ...
                    <div class="cr--payday-slider__item__properties">
                        <div class="cr--payday-slider__item__properties__amount">
                            <div class="cr--payday-slider__item__padder">
                                ...
                                <div class="cr--payday-slider__item__properties__value"><?php echo esc_html($loanAmount); ?></div>
                                <div class="cr--payday-slider__item__properties__note <?php echo esc_attr($featured !== '' ? $featuredNoteStyle : $noteStyle); ?>">
                        ...
                        <div class="cr--payday-slider__item__properties__period">
                            <div class="cr--payday-slider__item__padder">
                                ...
                                <div class="cr--payday-slider__item__properties__value"><?php echo esc_html($loanLength); ?></div>
                                <div class="cr--payday-slider__item__properties__note <?php echo esc_attr($featured !== '' ? $featuredNoteStyle : $noteStyle); ?>">
                    ...
                    <div class="cr--payday-slider__item__cta">
                        <div class="cr--payday-slider__item__padder">
                            <a <?php echo $onClick; ?>
                                ...
                                target="_blank"
                                title="<?php echo esc_attr($offer['loan_simulation']); ?>"
                                class="cr--payday-slider__item__cta__button <?php echo esc_attr($ctaStyle);?>">
                                <?php echo $ctaText; ?>
                            </a>
                        </div>
                    </div>
